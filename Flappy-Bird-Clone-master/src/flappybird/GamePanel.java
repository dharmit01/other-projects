...
public class GamePanel extends JPanel {
    ...
    private Image pipeHead, pipeLength, img;
    ...
    public GamePanel(FlappyBird fb, Bird bird, ArrayList<Rectangle> rects) {
        ...
        this.bird = bird;
        this.rects = rects;
        scoreFont = new Font("Product Sans", Font.BOLD, 18);
        pauseFont = new Font("Product Sans", Font.BOLD, 42);
        
        try {
            img = ImageIO.read(new File("bg-image-1.png"));
        }
        catch(IOException e) {
            e.printStackTrace();
        }
...
//        	g.fillRect(0,0,FlappyBird.WIDTH,FlappyBird.HEIGHT);
        ...
        if(fb.paused()) {
            ...
            g.drawString("PRESS ENTER TO BEGIN", FlappyBird.WIDTH/2-250, FlappyBird.HEIGHT/2+75);
            g.drawString("Use Space To Jump", FlappyBird.WIDTH/2-210, FlappyBird.HEIGHT/2+150);
        }
    }
}
